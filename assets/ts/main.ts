...
const launchTitle = document.getElementById('launch-title') as HTMLHeadingElement | null;
const launchDetails = document.getElementById('launch-details') as HTMLDivElement | null;
    ...
    btn.addEventListener('click', async () => {
        ...
        try {
            ...
            if (data.results && data.results.length > 0) {
                const launch = data.results[0] as Launch;
